  ...
  return<div className="mt-40">
   ...
   <section className="py-20 bg-blue-50 ">
    <div className="mx-auto px-4">
      <div className="grid grid-cols-2 mx-auto px-4 md:grid-cols-4 gap-8">
   ...
   <section className="py-20">
    <div className=" mx-auto px-4">
      <h2 className="text-3xl font-bold text-center mb-12">Everything you need to manage your finances
      </h2>
   ...
   <section className="py-20  bg-blue-50">
    <div className=" mx-auto px-4">
      <h2 className="text-3xl font-bold text-center mb-12">How It Works
      </h2>
   ...
   <section className="py-20">
    <div className=" mx-auto px-4">
      <h2 className="text-3xl font-bold text-center mb-12">What Our Users Say
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3  gap-8">
              ...
              <CardContent className="pt-4">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                     ...
                     <div className="text-sm text-gray-600">{testimonial.role}
                     </div>
                  </div>
                </div>
